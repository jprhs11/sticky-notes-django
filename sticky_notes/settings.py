...
SECRET_KEY = 'django-insecure-$d9l*=!a$dgihn9x$h7piwemoyrpmzez(ui*hu$bbt^x9-0!^s'
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR, 'notes/templates')], # Add this line
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
# The directory where you will store your custom CSS/JS
STATICFILES_DIRS = [
